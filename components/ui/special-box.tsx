...
export function SpecialBox({ children, className, ...props }: SpecialBoxProps) {
    return (
        <div className={cn("relative mb-8 w-fit max-w-full md:max-w-2/3 not-prose", className)} {...props}>
            ...
            <div className="relative z-10 border border-[#89937a] p-4 w-full bg-background transition-colors duration-500">
            ...
            <div className="absolute top-[5px] left-[5px] w-full h-full border-r border-b border-[#89937a] z-0 pointer-events-none transition-colors duration-500"></div>
        </div>
    );
}
